...
public class EngineMap extends ServoMap
  ...
  public EngineMap(ServoCommand servoCommand) {
    ...
    LOG.info(String.format(
        "Engine gpio: %3d reverse: %3d - %3d forward %3d - %3d zero: %3d  steps:  %3d",
        ENGINE_GPIO, MIN_SPEED_REVERSE, MAX_SPEED_REVERSE, MIN_SPEED_FORWARD,
        MAX_SPEED_FORWARD, SPEED_ZERO, SPEED_STEP_SIZE));
    super.configure(ENGINE_GPIO, servoCommand);
  }
